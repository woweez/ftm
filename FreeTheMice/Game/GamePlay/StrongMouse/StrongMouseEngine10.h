...
@interface StrongMouseEngineMenu10 : CCLayer {
    
    
}

@end
@interface StrongMouseEngine10 : CommonEngine {
...
//    CCSprite *starSprite[6];
    ...
    CCSprite *pieSprite;
    CCSprite *combinationFreezeSprite[3][3];
    CCSprite *dotSprite;
...
//    int gameMinutes;
    ...
    CCLabelAtlas *combButtonAtlas[3];
    int cheeseX2;
    int cheeseY2;
