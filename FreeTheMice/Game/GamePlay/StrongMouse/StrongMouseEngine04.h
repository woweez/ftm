...
@interface StrongMouseEngineMenu04 : CCLayer {
    
    
}

@end
@interface StrongMouseEngine04 : CommonEngine {
...
//    CCSprite *starSprite[6];
    ...
    CCSprite *silverPotSprite;
    CCSprite *toasterBreadSprite;
    CCSprite *greyBoxSprite;
