...
@interface StrongMouseEngineMenu02 : CCLayer {
    

}

@end
@interface StrongMouseEngine02 : CommonEngine {
...
//    CCSprite *starSprite[6];
    ...
    CCSprite *stoolSprite;
    CCSprite *honeyPotSprite;
    CCSprite *gateSprite;
    CCSprite *honeyBottleSprite;
