...
GirlMouseEngineMenu09 *gLayer09;

@implementation GirlMouseEngineMenu09
...
@implementation GirlMouseEngine09
...
+(CCScene *) scene {
    ...
    gLayer09=[GirlMouseEngineMenu09 node];
    [scene addChild:gLayer09 z:1];
    
    GirlMouseEngine09 *layer = [GirlMouseEngine09 node];
...
//        [self addChild:catSpriteSheet z:1];
        ...
        [gLayer09 addChild:mouseTrappedBackground z:10];
        ...
        [gLayer09 addChild:progressBarBackSprite z:10];
        ...
        [gLayer09 addChild:cheeseCollectedSprite z:10];
        ...
        [gLayer09 addChild:timeCheeseSprite z:10];
        ...
        [gLayer09 addChild:lifeMinutesAtlas z:10];
        ...
        [gLayer09 addChild:cheeseCollectedAtlas z:10];
        ...
        platformSprite.position=ccp(650,480);
        [self addChild:platformSprite z:0];
        
        platformSprite=[CCSprite spriteWithFile:@"sticky_platform.png"];
        platformSprite.position=ccp(220,400);
        platformSprite.rotation=90;
        platformSprite.scaleX=0.7;
        [self addChild:platformSprite z:10];
        
        platformSprite=[CCSprite spriteWithFile:@"sticky_platform.png"];
        platformSprite.position=ccp(10,520);
        platformSprite.rotation=-90;
        platformSprite.scaleX=0.7;
        [self addChild:platformSprite z:10];
        
        platformSprite=[CCSprite spriteWithFile:@"sticky_platform.png"];
        platformSprite.position=ccp(450,740);
        [self addChild:platformSprite z:10];
        
        platformSprite=[CCSprite spriteWithFile:@"sticky_platform.png"];
        platformSprite.position=ccp(557,372);
        platformSprite.scaleX=0.9;
        [self addChild:platformSprite z:10];
        
        movePlateformSprite=[CCSprite spriteWithFile:@"move_platform3.png"];
        movePlateformSprite.position=ccp(870,268);
        [self addChild:movePlateformSprite z:0];
        
        CCSprite *windowSprite=[CCSprite spriteWithFile:@"window1.png"];
        windowSprite.position=ccp(430,480);
        windowSprite.scale=1.3;
        [self addChild:windowSprite z:1];
        
        windowSprite=[CCSprite spriteWithFile:@"window1.png"];
        windowSprite.position=ccp(570,480);
        windowSprite.scale=1.3;
        [self addChild:windowSprite z:1];
        
        visibleSprite[4]=[CCSprite spriteWithFile:@"apple_wood.png"];
        visibleSprite[4].position=ccp(300,302);
        visibleSprite[4].rotation=90;
        visibleSprite[4].scaleX=0.75;
        [self addChild:visibleSprite[4] z:10];
        
        visibleSprite[5]=[CCSprite spriteWithFile:@"apple_wood.png"];
        visibleSprite[5].position=ccp(300,482);
        visibleSprite[5].rotation=90;
        visibleSprite[5].scaleX=0.75;
        [self addChild:visibleSprite[5] z:10];
        
        CCSprite *appleWoodSprite=[CCSprite spriteWithFile:@"apple_wood_back.png"];
        appleWoodSprite.position=ccp(300,302);
        appleWoodSprite.rotation=90;
        appleWoodSprite.scaleX=0.75;
        [self addChild:appleWoodSprite z:0];
        
        appleWoodSprite=[CCSprite spriteWithFile:@"apple_wood_back.png"];
        appleWoodSprite.position=ccp(300,482);
        appleWoodSprite.rotation=90;
        appleWoodSprite.scaleX=0.75;
        [self addChild:appleWoodSprite z:0];
        
        visibleSprite[0]=[CCSprite spriteWithFile:@"window2.png"];
        visibleSprite[0].position=ccp(400,480);
        visibleSprite[0].scale=1.28;
        [self addChild:visibleSprite[0] z:10];
        
        visibleSprite[1]=[CCSprite spriteWithFile:@"window2.png"];
        visibleSprite[1].position=ccp(470,480);
        visibleSprite[1].scale=1.28;
        visibleSprite[1].flipX=1;
        [self addChild:visibleSprite[1] z:10];
        
        visibleSprite[2]=[CCSprite spriteWithFile:@"window2.png"];
        visibleSprite[2].position=ccp(530,480);
        visibleSprite[2].scale=1.28;
        [self addChild:visibleSprite[2] z:10];
        
        visibleSprite[3]=[CCSprite spriteWithFile:@"window2.png"];
        visibleSprite[3].position=ccp(600,480);
        visibleSprite[3].scale=1.28;
        ...
        switchAtlas.position=ccp(120,650);
        ...
        switchAtlas2.position=ccp(960,555);
        ...
        switchAtlas3.position=ccp(420,285);
        ...
        dotSprite.position=ccp(635,375);
        dotSprite.scale=0.2;
...
-(void) addHudLayerToTheScene{
    ...
    hudLayer.tag = 9;
    [gLayer09 addChild: hudLayer z:2000];
...
-(void) addLevelCompleteLayerToTheScene{
    ...
    [gLayer09 addChild: lvlCompleteLayer z:2000];
}
-(void)initValue{
...
-(void)catFunc{
    ...
    if (!catJumpChe && catObj1 == nil) {
        catObj1 = [[GirlLevel9Cat alloc] init];
        [catObj1 runCurrentSequenceForFirstCat];
        [self addChild:catObj1];
    }
    
    if(!catBackChe){
        if(catMovementCount<280){
            if(turnAnimationCount==0){
                catX=[trigo circlex:catMovementCount a:359]+260;
...
-(void)secondCatFunc{
    ...
    if (!catJumpChe && catObj2== nil) {
        catObj2 = [[GirlLevel9Cat alloc] init];
        [catObj2 runCurrentSequenceForSecondCat];
        [self addChild:catObj2];
    }
    if(!catBackChe2){
        if(catMovementCount2<=640){
            if(turnAnimationCount2==0){
                catX2=[trigo circlex:catMovementCount2 a:359]+60;
...
-(void)collisionFunc{
    ...
    if(hx-iValue>350 &&hx-iValue<440 &&hy>=290 && hy<=340&& screenMovementFindValue3==0){
        ...
        if(screenMovementFindValue == 0&&screenMovementFindValue2!=0){
            ...
            screenMovementFindValue2=0;
            [switchAtlas2 setString:@"0"];
        }else if(screenMovementFindValue != 0 &&screenMovementFindValue2==0){
            screenMovementFindValue=0;
            [switchAtlas setString:@"0"];
            screenMovementFindValue2=0;
            [switchAtlas2 setString:@"0"];
        ...
        if(screenMovementFindValue!=0&&screenMovementFindValue2!=0){
            combinationSuccessChe=YES;
        }
    }
    
    if(hx-iValue>=190 &&hx-iValue<610 &&hy>=400 && hy<= 588){
        visibleCount+=15;
        if(visibleCount>=250){
            visibleCount=250;
        }
    ...
    }else if(hx-iValue>=190 &&hx-iValue<370 &&hy>=220 && hy<= 400){
        visibleCount+=15;
        if(visibleCount>=250){
            visibleCount=250;
        }
...
-(void)switchFunc{
    ...
    if(screenMoveChe){
        if(screenMovementFindValue==2){
            ...
            if(screenShowY>600){
                screenShowY=600;
                gameFunc.moveCount2+=2;
                if(gameFunc.moveCount2>290){
                    gameFunc.moveCount2=290;
        ...
        if(screenMovementFindValue2 == 2){
            ...
            if(screenShowY<350){
                ...
                if(!cButtonChe){
                    gameFunc.moveCount2+=2;
                    if(gameFunc.moveCount2>160){
                        gameFunc.moveCount2=160;
        ...
        if(screenMovementFindValue3 == 2){
            screenShowX+=5;
            if(screenShowX>=750){
                screenShowX=750;
                if(aButtonChe){
                    gameFunc.moveCount2+=2;
                    if(gameFunc.moveCount2>40){
                        gameFunc.moveCount2=40;
                        screenMovementFindValue3=3;
                    }
                }else{
                    gameFunc.moveCount2-=2;
                    if(!combinationSuccessChe){
                        if(gameFunc.moveCount2<40){
                            gameFunc.moveCount2=40;
                            screenMovementFindValue3=3;
                        }
                    }else{
                        if(gameFunc.moveCount2<95){
                            gameFunc.moveCount2=95;
                            screenMovementFindValue3=3;
                        }
                    }
                }
...
-(void)level05{
    ...
    movePlateformSprite.position=ccp(870,268+gameFunc.moveCount2);
...
-(void)level01{
    ...
    if(heroSprite.position.x>=850+fValue && heroSprite.position.y>350 && heroSprite.position.y<=450&&!mouseWinChe&&!gameFunc.trappedChe&&combinationSuccessChe){
