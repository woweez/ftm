...
GirlMouseEngineMenu05 *gLayer05;

@implementation GirlMouseEngineMenu05
...
@implementation GirlMouseEngine05
...
+(CCScene *) scene {
    ...
    gLayer05=[GirlMouseEngineMenu05 node];
    [scene addChild:gLayer05 z:1];
    
    GirlMouseEngine05 *layer = [GirlMouseEngine05 node];
...
//        
        ...
        [gLayer05 addChild:mouseTrappedBackground z:10];
        ...
        [gLayer05 addChild:progressBarBackSprite z:10];
        ...
        [gLayer05 addChild:cheeseCollectedSprite z:10];
        ...
        [gLayer05 addChild:timeCheeseSprite z:10];
        ...
        [gLayer05 addChild:lifeMinutesAtlas z:10];
        ...
        [gLayer05 addChild:cheeseCollectedAtlas z:10];
        ...
        stickyPlatfromSprite.position=ccp(530,390);
        stickyPlatfromSprite.scaleX=0.7;
        [self addChild:stickyPlatfromSprite z:10];
        
        CCSprite *windowSprite=[CCSprite spriteWithFile:@"window2.png"];
        windowSprite.position=ccp(-15,473);
        windowSprite.scaleY=1.1;
        windowSprite.scaleX=1.1;
        [self addChild:windowSprite z:1];
        
        windowSprite=[CCSprite spriteWithFile:@"window2.png"];
        windowSprite.position=ccp(47,473);
        ...
        windowSprite=[CCSprite spriteWithFile:@"window2.png"];
        windowSprite.position=ccp(200,473);
        windowSprite.scaleY=1.1;
        windowSprite.scaleX=1.1;
        [self addChild:windowSprite z:1];
        
        windowSprite=[CCSprite spriteWithFile:@"window2.png"];
        windowSprite.position=ccp(257,473);
        windowSprite.scaleY=1.1;
        windowSprite.scaleX=1.1;
        windowSprite.flipX=1;
        [self addChild:windowSprite z:1];
        ...
        windowSprite=[CCSprite spriteWithFile:@"window2.png"];
        windowSprite.position=ccp(318,473);
        windowSprite.scaleY=1.1;
        windowSprite.scaleX=1.1;
        [self addChild:windowSprite z:1];
        
        windowSprite=[CCSprite spriteWithFile:@"window1.png"];
        windowSprite.position=ccp(976,517);
...
//        vesselsSprite.scale=0.6;
        ...
        dotSprite.position=ccp(865,345);
        dotSprite.scale=0.2;
...
-(void) addHudLayerToTheScene{
    ...
    hudLayer.tag = 5;
    [gLayer05 addChild: hudLayer z:2000];
...
-(void) addLevelCompleteLayerToTheScene{
    ...
    [gLayer05 addChild: lvlCompleteLayer z:2000];
}
-(void)initValue{
...
-(void)catFunc{
    ...
    if(!catJumpChe && catObj == nil){
        catObj = [[GirlLevel5Cat alloc] init];
    ...
    if(!catEscapeChe){
        if(!catBackChe){
            if(catMovementCount<55){
                if(turnAnimationCount==0){
                    catX=[trigo circlex:catMovementCount a:359]+370;
                    catY=[trigo circley:catMovementCount a:359]+414;
                    catMovementCount+=1;
            ...
            }else if(catMovementCount>=55 &&catMovementCount<160){
                if(catMovementCount==55){
                    if(turnAnimationCount==0){
                        catJumpChe=YES;
                        catMovementCount=56;
                    ...
                    if(catJumpingAnimationCount>=55){
                        catX=[trigo circlex:65 a:catMovementCount-50]+356;
                        catY=[trigo circley:140 a:catMovementCount-50]+397;
                        catMovementCount+=1.0;
                        
                        if(catJumpingAnimationCount>=55&&catMovementCount>130){
            ...
            }else if(catMovementCount>=160 && catMovementCount<270){
                if(!catJumpChe){
                    catX=[trigo circlex:catMovementCount-160 a:179]+327;
                    catY=[trigo circley:catMovementCount-160 a:179]+560;
                    catMovementCount+=1;
                    if(catAnimationCount%2 == 0)
                        [self catSpriteGenerate:catAnimationCount/2 animationType:@"run"];
                    if(catMovementCount>=270){
            ...
            }else if(catMovementCount>=270&&catMovementCount<389){
                if(catJumpingAnimationCount>=55){
                    catX=[trigo circlex:58 a:catMovementCount-240]+128;
                    catY=[trigo circley:70 a:catMovementCount-240]+516;
                    catMovementCount+=2;
                    if(catJumpingAnimationCount>=55){
                        catJumpingAnimationCount+=1;
                        catJumpingAnimationCount=(catJumpingAnimationCount>=90?90:catJumpingAnimationCount);
            ...
            }else if(catMovementCount>=389&&catMovementCount<420){
                if(!catJumpChe){
                    catX=[trigo circlex:catMovementCount-389 a:179]+65;
                    catY=[trigo circley:catMovementCount-389 a:179]+560;
                    catMovementCount+=1;
                    if(catAnimationCount%2 == 0)
                        [self catSpriteGenerate:catAnimationCount/2 animationType:@"run"];
                    if(catMovementCount>=420){
                        catMovementCount=420;
                        turnAnimationCount=1;
                        catBackChe=YES;
                    }
                }else{
            ...
            if(catMovementCount>389&&catMovementCount<=420){
                if(turnAnimationCount==0){
                    catX=[trigo circlex:catMovementCount-389 a:179]+65;
                    catY=[trigo circley:catMovementCount-389 a:179]+560;
                    catMovementCount-=1;
        ...
        if(catMovementCount>=270&& catMovementCount<390){
            
            if(!catJumpChe){
                if(turnAnimationCount==0)
                    catJumpChe=YES;
            }else{
                if(catJumpingAnimationCount>=55&&turnAnimationCount==0){
                    catX=[trigo circlex:40 a:catMovementCount-205]+170;
                    catY=[trigo circley:170 a:catMovementCount-205]+367;
                    catMovementCount+=1;
                    if(catJumpingAnimationCount>=55){
                        catJumpingAnimationCount+=1;
                        catJumpingAnimationCount=(catJumpingAnimationCount>=90?90:catJumpingAnimationCount);
        ...
        }else if(catMovementCount>=390&&catMovementCount<462){
            
            if(catMovementCount == 390){
                if(catJumpChe){
                    if(catJumpingAnimationCount<=105){
                        catJumpingAnimationCount+=1;
                        if(catJumpingAnimationCount%5 == 0)
                        ...
                        catJumpingAnimationCount=0;
                        catJumpChe=YES;
                        catMovementCount=391;
                    }
                }
            }else{
                if(catMovementCount<460){
                    if(catJumpingAnimationCount>=55){
                        catX=[trigo circlex:105 a:catMovementCount-310]+96;
                        catY=[trigo circley:40 a:catMovementCount-310]+299;
                        catMovementCount+=1;
                        if(catJumpingAnimationCount>=55){
                            catJumpingAnimationCount+=1;
                            catJumpingAnimationCount=(catJumpingAnimationCount>=90?90:catJumpingAnimationCount);
...
-(void)heroLandingFunc{
    if(landingChe){
        ...
        if(heroJumpingAnimationCount>18){
            ...
            if(!screenMoveChe&&screenMovementFindValue==0&&gameFunc.switchCount==1&&!gameFunc.trappedChe){
                screenMoveChe=YES;
