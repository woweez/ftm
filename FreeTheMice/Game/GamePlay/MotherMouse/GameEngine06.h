...
@interface GameEngine06Menu : CCLayer {
        
}
@end

@interface GameEngine06 : CommonEngine {
...
//    CCSprite *heroRunSprite;
    ...
    CCSprite *dotSprite;
//    added by Kamran start
    CCSprite *catRunSprite;
    CCSprite *catTurnSprite;
    CCSprite *mouseJumpImageAnimation;
    CCSpriteBatchNode *catSpriteSheet;
    CCSpriteBatchNode *catKnockedSpriteSheet;
    CCSpriteBatchNode *catKnockedSpriteSheet2;
    BOOL catKnockedOut;
