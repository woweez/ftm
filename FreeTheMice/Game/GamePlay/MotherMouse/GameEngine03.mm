...
GameEngine03Menu *layer03;

@implementation GameEngine03Menu
...
+(CCScene *) scene {
    ...
    layer03=[GameEngine03Menu node];
    [scene addChild:layer03 z:1];
    GameEngine03 *layer = [GameEngine03 node];
...
-(id) init
{
    if( (self=[super init])) {
        ...
        [layer03 addChild:progressBarBackSprite z:10];
        ...
        [layer03 addChild:cheeseCollectedSprite z:10];
        ...
        [layer03 addChild:progressBarSprite[0] z:10];
        ...
        [layer03 addChild:timeCheeseSprite z:10];
        ...
        [layer03 addChild:lifeMinutesAtlas z:10];
        ...
        [layer03 addChild:cheeseCollectedAtlas z:10];
        ...
        [layer03 addChild:mouseTrappedBackground z:10];
...
-(void) addHudLayerToTheScene{
    ...
    hudLayer.tag = 3;
    [layer03 addChild: hudLayer z:2000];
