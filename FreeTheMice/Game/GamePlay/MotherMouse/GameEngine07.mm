...
GameEngine07Menu *layer07;

@implementation GameEngine07Menu
...
+(CCScene *) scene {
    ...
    layer07=[GameEngine07Menu node];
    [scene addChild:layer07 z:1];
    GameEngine07 *layer = [GameEngine07 node];
...
-(id) init
{
    if( (self=[super init])) {
        ...
        [layer07 addChild:progressBarBackSprite z:10];
        ...
        [layer07 addChild:cheeseCollectedSprite z:10];
        ...
        [layer07 addChild:progressBarSprite[0] z:10];
        ...
        for(int i=1;i<120;i++){
            ...
            [layer07 addChild:progressBarSprite[i] z:10];
        }
        ...
        [layer07 addChild:timeCheeseSprite z:10];
        ...
        [layer07 addChild:lifeMinutesAtlas z:10];
        ...
        [layer07 addChild:cheeseCollectedAtlas z:10];
        ...
        switchAtlas.position=ccp(307,475);
        ...
        switchAtlas2.position=ccp(242,260);
        ...
        woodSprite.position=ccp(322,300);
        ...
        woodSprite.position=ccp(322,390);
        woodSprite.scaleX=0.79;
        woodSprite.scaleY=0.69;
        [self addChild:woodSprite z:10];
        ...
        [layer07 addChild:clockBackgroundSprite z:0];
        ...
        [layer07 addChild:clockArrowSprite z:0];
        ...
        CCSprite *objectSprite=[CCSprite spriteWithFile:@"pulb.png"];
        objectSprite.position=ccp(646,635);
        [self addChild:objectSprite z:0];
        
        CCSprite *pSprite=[CCSprite spriteWithFile:@"move_platform3.png"];
        pSprite.position=ccp(936,433);
        ...
        [layer07 addChild:mouseTrappedBackground z:10];
...
-(void) addHudLayerToTheScene{
    ...
    hudLayer.tag = 7;
    [layer07 addChild: hudLayer z:2000];
...
-(void) addLevelCompleteLayerToTheScene{
    ...
    [layer07 addChild: lvlCompleteLayer z:2000];
}
    ...
    if(screenMoveChe){
        if(screenShowX<650&&gameFunc.moveCount2==0)
            ...
            if(gameFunc.domeMoveCount!=130)
                screenShowY+=2;
            else if(gameFunc.domeMoveCount==130 && screenShowY!=screenShowY2){
                screenShowY-=2;
                screenShowY=(screenShowY<=screenShowY2?screenShowY2:screenShowY);
            }else{
                screenShowX-=7;
...
-(void)heroLandingFunc{
    if(landingChe){
        ...
        if(heroJumpingAnimationCount>18){
            ...
            if(gameFunc.domeSwitchChe&&!screenMoveChe&&!safetyJumpChe){
                screenMoveChe=YES;
                screenShowX=platformX;
                screenShowY=platformY;
...
-(void ) respwanTheMice{
    ...
    if (jumpingChe) {
        ...
        [self endJumping:platformX  yValue:[gameFunc getPlatformPosition:motherLevel].y];
        [self schedule:@selector(startRespawnTimer) interval:2];
