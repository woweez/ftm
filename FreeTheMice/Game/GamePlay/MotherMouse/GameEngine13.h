...
@interface GameEngine13Menu : CCLayer {
    
}
@end

@interface GameEngine13 : CommonEngine {
...
//    CCSprite *heroRunSprite;
    ...
    CCSprite *knifeSprite2;
    CCSprite *knifeSprite3;
    CCSprite *knifeSprite4;
